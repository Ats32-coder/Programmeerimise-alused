"""
1. Koosta vähemalt kümnest elemendist koosnev järjend arvudest.
2. Koosta programm, mis küsib kasutajalt tegurit ja
3. korrutab kõik algses järjendis olnud arvud sellega läbi ning
4. väljastab tulemuse ekraanile.
"""
...
if __name__ == '__main__':
    numbers_list = generate_number_list(16, 100)
