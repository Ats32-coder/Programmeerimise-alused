...
class Student:
    ...
    def is_participating(self, course_name: str) -> bool:
        """Return true if student is participating in given course."""
...
def filter_by_course(student_list: list, course: str) -> list:
    ...
    """
    return list(filter(lambda s: s.is_participating(course), student_list))
...
def succeeding_students(student_list: list) -> list:
    ...
    """
    return list(filter(lambda s: not s.is_failing(), student_list))
...
def failing_students(student_list: list) -> list:
    ...
    """
    return list(filter(lambda s: s.is_failing(), student_list))
...
def sort_by_best_grade(student_list: list) -> list:
    ...
    """
    passing_students = succeeding_students(student_list)
    return sorted(passing_students, key=lambda s: s.gpa, reverse=True)
...
def sort_by_worst_grade(student_list: list) -> list:
    ...
    """
    passing_students = succeeding_students(student_list)
    return sorted(passing_students, key=lambda s: s.gpa, reverse=False)
