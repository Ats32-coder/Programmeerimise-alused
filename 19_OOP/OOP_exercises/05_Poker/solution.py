...
class Hand:
    ...
    def can_add_card(self, card: Card) -> bool:
        ...
        """
        is_valid_suit = card.suit in self.suits
        is_valid_value = card.value in self.values

        if not (is_valid_suit and is_valid_value):
            return False
    ...
    def is_straight(self):
        ...
        for card in self.cards:
            index = self.values.index(card.value)
