...
Loo programm, mis abistaks ristsõna lahendajat: kasutajalt küsitakse sõna pikkust ning esimest ja viimast tähte ning
väljastatakse sõnastikus olevad kõikvõimalikud sellised sõnad. Sõnastiku (algvormide e. lemmade loendi) võid leida näiteks siit:
http://www.eki.ee/tarkvara/wordlist/. Arendusvõimalusi:
...
if __name__ == '__main__':
    beginning = input("Sisesta sõna algus: ")
