...
def test__students_study__night_with_coffee__no_studying():
    """Students do not study at night, even if they have coffee."""
...
def test__students_study__night_without_coffee__no_studying():
    """Students do not study at night without coffee."""
...
def test__students_study__evening_with_coffee__studying():
    """Students study in the evening when they have coffee."""
...
def test__students_study__evening_without_coffee__studying():
    """Students study in the evening even without coffee."""
...
def test__students_study__day_with_coffee__studying():
    """Students study during the day if they have coffee."""
...
def test__students_study__day_without_coffee__no_studying():
    """Students do not study during the day without coffee."""
...
def test_lottery_all_equal():
    """If all values are equal: return 10 if they are 5, otherwise return 5."""
...
def test_fruit_order__large_less():
    """If big baskets are not enough, use small ones if possible, else return -1."""
...
def test_fruit_order__large_more():
    """If big baskets exceed the order, use only what is needed and check remainder."""
...
def test_fruit_order__large_zero():
    """If no big baskets are available, rely only on small ones or fail."""
...
def test_fruit_order_zero():
    """If ordered amount is zero, result is always zero."""
